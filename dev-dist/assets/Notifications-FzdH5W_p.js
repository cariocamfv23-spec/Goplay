							...
							not.user || not.imageUrl || not.avatarUrl || not.type === "friend_suggestion" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Avatar, {
										className: cn("h-10 w-10 ring-2 ring-offset-2 ring-offset-background", not.type === "live_stream" ? not.link?.includes("/replay/") ? "ring-primary" : "ring-red-500" : not.type === "friend_suggestion" ? "ring-pink-500" : "ring-transparent border border-border"),
									...
									not.type === "friend_suggestion" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "absolute -bottom-1 -right-1 h-4 w-4 bg-pink-500 border-2 border-background rounded-full flex items-center justify-center shadow-sm",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserPlus, { className: "h-2 w-2 text-white" })
									})
								]
							}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
//# sourceMappingURL=Notifications-FzdH5W_p.js.map