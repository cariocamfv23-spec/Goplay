...
import { $r as require_react, Kn as Lock, O as useAuthStore, Tr as ArrowRight, Ur as require_jsx_runtime, Xr as useNavigate, Xt as Logo, a as SportsWallpaper, kr as createLucideIcon, mn as toast, n as PageLoader, nn as Button, xn as User } from "./index-gMWuR-H4.js";
...
import { t as Checkbox } from "./checkbox-Bkr-tR_U.js";
...
function Login() {
	...
	(0, import_react.useEffect)(() => {
		if (hasHydrated) if (isAuthenticated) navigate("/home", { replace: true });
		else {
	...
	if (!hasHydrated || isChecking) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageLoader, {});
...
//# sourceMappingURL=Login-DATSc-Pk.js.map