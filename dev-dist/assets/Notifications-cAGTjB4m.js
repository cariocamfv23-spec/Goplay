import { An as TrendingDown, Bn as ShieldCheck, Mn as Target, On as Trophy, Or as Bell, Tr as Calendar, V as Badge, Yr as require_jsx_runtime, _r as Clock, an as Button, ar as GraduationCap, bn as cn, en as Avatar, fr as Eye, gr as CloudLightning, jr as ArrowLeft, kn as TrendingUp, kr as Baby, mr as Crown, ni as useNavigate, nn as AvatarImage, nr as Heart, rr as Handshake, tn as AvatarFallback, xn as Zap, z as useNotificationStore_default } from "./index-DkGwRTO2.js";
					...
					children: items.map((not) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							not.type === "live_stream" && not.user ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								className: cn("mt-1 h-10 w-10 rounded-full flex items-center justify-center shrink-0 border border-border/50", not.read ? "bg-secondary/50" : "bg-secondary", isVipAlert(not.title, not.message) && "bg-gold/10 border-gold/30", not.title.toLowerCase().includes("scout") && "bg-blue-500/10 border-blue-500/30", not.title.toLowerCase().includes("sponsor") && "bg-emerald-500/10 border-emerald-500/30"),
...
//# sourceMappingURL=Notifications-cAGTjB4m.js.map