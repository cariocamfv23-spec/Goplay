import { t as ChevronDown } from "./chevron-down-BZ0ZyufL.js";
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-D-vFR9-j.js";
import { t as CirclePlay } from "./circle-play-Dnh1fxfb.js";
import { t as Crosshair } from "./crosshair-oCGZe1pt.js";
import { t as Gift } from "./gift-CvUZTFvm.js";
import { t as Ticket } from "./ticket-C8rDJjCt.js";
import { $n as Map, An as Trophy, En as Users, Er as CircleCheckBig, Nr as Calendar, Pn as Target, R as Badge, Rn as Star, Vr as Activity, ar as Info, c as DialogTrigger, hr as Flame, jn as TrendingUp, mi as require_react, o as DialogHeader, oi as useToast, on as Button, r as DialogContent, ri as require_jsx_runtime, s as DialogTitle, t as Dialog, ui as useNavigate, xn as cn, yi as __toESM, zr as ArrowLeft } from "./index-CGwwiF4x.js";
import { a as CardHeader, n as CardContent, o as CardTitle, t as Card } from "./card-DFtD1G2a.js";
import { i as Root, n as CollapsibleTrigger$1, t as CollapsibleContent$1 } from "./dist-B5BtL8rp.js";
import { M as Cell, f as Bar, n as YAxis, r as XAxis } from "./generateCategoricalChart-DB7D-30j.js";
import { i as PolarGrid, n as Radar, r as PolarAngleAxis, t as RadarChart } from "./RadarChart-DMJ4qN3W.js";
import { t as BarChart } from "./BarChart-DzS9IFiV.js";
import { n as ChartTooltip, r as ChartTooltipContent, t as ChartContainer } from "./chart-hDLYwT-3.js";
import { a as TableHeader, i as TableHead, n as TableBody, o as TableRow, r as TableCell, t as Table } from "./table-Bp137e-L.js";
...
function CopaStatsDashboard() {
	...
	const submitPrediction = () => {
		...
		if (isPerfect) setShowVoucher(selectedMatch);
		else toast({
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: BOLAO_MATCHES.map((match) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
									...
									children: [predictions[match.id]?.status === "won" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "absolute top-0 right-0 bg-green-500 text-white text-[9px] font-black uppercase tracking-widest px-2 py-1 rounded-bl-lg z-10 shadow-sm",
										children: "Na Mosca!"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "p-4",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "text-[10px] text-muted-foreground font-bold uppercase mb-3 flex justify-between",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: match.date }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: match.stadium })]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "flex justify-between items-center mb-4",
												children: [
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
														className: "flex flex-col items-center justify-center w-[30%]",
														children: predictions[match.id] ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												...
												children: predictions[match.id] ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														...
														variant: predictions[match.id].status === "won" ? "default" : "secondary",
														className: cn("w-full justify-center py-1", predictions[match.id].status === "won" && "bg-green-500 hover:bg-green-600 text-white shadow-sm"),
														children: predictions[match.id].status === "won" ? "Prêmio Desbloqueado" : "Aguardando Resultado"
													})]
												}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
					className: "sm:max-w-md bg-gradient-to-br from-indigo-950 to-purple-950 border-[hsl(var(--gold))] text-white",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogTitle, {
						className: "text-2xl font-black text-[hsl(var(--gold))] text-center uppercase tracking-widest flex items-center justify-center gap-2 drop-shadow-md",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trophy, { className: "w-6 h-6" }), " Na Mosca!"]
					}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex flex-col items-center gap-4 py-4",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "w-32 h-32 rounded-full bg-black/40 border-4 border-[hsl(var(--gold))] p-4 flex items-center justify-center relative shadow-[0_0_40px_hsl(var(--gold)/0.4)] animate-in zoom-in duration-500",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Gift, { className: "w-16 h-16 text-[hsl(var(--gold))] animate-bounce" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "text-center space-y-2 w-full px-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									className: "text-lg font-bold text-white",
									children: "Parabéns! Você acertou em cheio!"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "bg-black/40 p-5 rounded-xl border border-white/20 mt-4 backdrop-blur-md relative overflow-hidden",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute top-0 right-0 w-32 h-32 bg-[hsl(var(--gold)/0.1)] blur-2xl rounded-full pointer-events-none" }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex items-center gap-2 mb-3 justify-center text-[hsl(var(--gold))] relative z-10",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Ticket, { className: "w-5 h-5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "font-black uppercase tracking-wider text-sm",
												children: "Voucher Desbloqueado"
											})]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
											className: "text-[13px] font-bold text-white/90 uppercase tracking-wide relative z-10",
											children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex items-center justify-center gap-1.5 mt-2 text-green-400 relative z-10",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheckBig, { className: "w-3.5 h-3.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "text-[11px] font-bold uppercase tracking-wider",
												children: "Inclui: Frete Gratuito para todo o Brasil"
											})]
										})
									]
								})]
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-[10px] text-center text-white/50 px-8 mt-2 leading-relaxed font-medium",
								children: "* Para resgatar, acesse a loja GoPlay e insira o código gerado em seu perfil. Em ambiente real, o prêmio está sujeito à disponibilidade de estoque."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
//# sourceMappingURL=CopaStatsDashboard-NWQ83ZA_.js.map