...
import { Lr as ArrowLeft, an as Button, di as require_react, k as Switch, li as require_jsx_runtime, si as useNavigate, vn as toast } from "./index-KrmgwaCy.js";
...
function PWASettings() {
	...
	const [pwaState, setPwaState] = (0, import_react.useState)({
		isInstalled: false,
		autoUpdate: true,
		notifications: false
	});
	(0, import_react.useEffect)(() => {
		...
		const loadSettings = () => {
			setTimeout(() => {
				...
				try {
					setPwaState({
						isInstalled: typeof window !== "undefined" && window.matchMedia ? window.matchMedia("(display-mode: standalone)").matches : false,
						autoUpdate: true,
						notifications: false
					});
				} catch (error) {
...
//# sourceMappingURL=PWASettings-B1AhQ0rZ.js.map