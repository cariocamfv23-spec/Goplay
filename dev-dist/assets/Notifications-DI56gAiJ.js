import { B as useNotificationStore_default, Cn as cn, Cr as Clock, Fn as Target, Fr as Baby, H as Badge, Lr as ArrowLeft, Mn as TrendingUp, Nn as TrendingDown, Pr as Bell, Sr as CloudLightning, Un as ShieldCheck, Xn as MessageCircle, Yn as MessageSquare, Zn as Megaphone, an as AvatarImage, br as Crown, ci as useNavigate, cn as Button, cr as Heart, dr as GraduationCap, in as AvatarFallback, jn as Trophy, jr as Calendar, lr as Handshake, rn as Avatar, sr as History, ti as require_jsx_runtime, vr as Eye, wn as Zap, z as useFlashbackStore } from "./index-BHonH2MR.js";
...
function Notifications() {
	...
	const handleNotificationClick = (not) => {
		...
		if (not.type === "time_travel") {
			openFlashback(not.link?.replace("modal:", "") || "today");
			return;
		}
			...
			children: hasNotifications ? Object.entries(groupedNotifications).map(([date, items]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
					...
					children: items.map((not) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: cn("p-4 rounded-xl flex gap-4 transition-all relative overflow-hidden border border-border/30 shadow-sm", not.read ? "bg-card opacity-90" : "bg-card ring-1 ring-primary/20 shadow-md", getPriorityStyle(not.priority, not.title, not.message, not.type), (not.link || not.type === "time_travel") && "cursor-pointer active:scale-[0.98]"),
...
//# sourceMappingURL=Notifications-DI56gAiJ.js.map