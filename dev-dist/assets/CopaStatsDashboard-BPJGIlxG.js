import { t as ChevronDown } from "./chevron-down-CRdbeU0c.js";
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-DHv6XQ8a.js";
import { En as Users, Pn as Target, R as Badge, Rn as Star, Vr as Activity, c as DialogTrigger, jn as TrendingUp, mi as require_react, o as DialogHeader, on as Button, r as DialogContent, ri as require_jsx_runtime, s as DialogTitle, t as Dialog, ui as useNavigate, xn as cn, yi as __toESM, zr as ArrowLeft } from "./index-0Kazi9ZY.js";
import { a as CardHeader, n as CardContent, o as CardTitle, t as Card } from "./card-zJWQ37dq.js";
import { i as Root, n as CollapsibleTrigger$1, t as CollapsibleContent$1 } from "./dist-BYFhZ-TB.js";
import { M as Cell, f as Bar, n as YAxis, r as XAxis } from "./generateCategoricalChart-BYYJAORB.js";
import { i as PolarGrid, n as Radar, r as PolarAngleAxis, t as RadarChart } from "./RadarChart-CWTrPn3t.js";
import { t as BarChart } from "./BarChart-DW1d0w1a.js";
import { n as ChartTooltip, r as ChartTooltipContent, t as ChartContainer } from "./chart-T2wGL7Fg.js";
		...
		keyPlayers: [
			{
				id: "neymar",
				name: "Neymar Jr.",
				image: "https://img.usecurling.com/p/256/256?q=neymar%20soccer%20brazil&dpr=2",
				stats: {
			...
			},
			{
				id: "vini",
				name: "Vini Jr.",
				image: "https://img.usecurling.com/p/256/256?q=vinicius%20jr%20real%20madrid&dpr=2",
				stats: {
			...
			},
			{
				id: "rodrygo",
				name: "Rodrygo",
				image: "https://img.usecurling.com/p/256/256?q=rodrygo%20soccer%20brazil&dpr=2",
				stats: {
		...
		keyPlayers: [
			{
				id: "mbappe",
				name: "Mbappé",
				image: "https://img.usecurling.com/p/256/256?q=kylian%20mbappe%20soccer%20france&dpr=2",
				stats: {
			...
			},
			{
				id: "griezmann",
				name: "Griezmann",
				image: "https://img.usecurling.com/p/256/256?q=griezmann%20soccer%20france&dpr=2",
				stats: {
			...
			},
			{
				id: "camavinga",
				name: "Camavinga",
				image: "https://img.usecurling.com/p/256/256?q=camavinga%20soccer%20france&dpr=2",
				stats: {
		...
		keyPlayers: [
			{
				id: "messi",
				name: "Messi",
				image: "https://img.usecurling.com/p/256/256?q=lionel%20messi%20soccer%20argentina&dpr=2",
				stats: {
			...
			},
			{
				id: "alvarez",
				name: "Julian Alvarez",
				image: "https://img.usecurling.com/p/256/256?q=julian%20alvarez%20soccer%20argentina&dpr=2",
				stats: {
			...
			},
			{
				id: "macallister",
				name: "Mac Allister",
				image: "https://img.usecurling.com/p/256/256?q=mac%20allister%20soccer%20argentina&dpr=2",
				stats: {
		...
		keyPlayers: [
			{
				...
				image: "https://img.usecurling.com/p/256/256?q=jude%20bellingham%20soccer%20england&dpr=2",
				stats: {
			...
			},
			{
				id: "kane",
				name: "Harry Kane",
				image: "https://img.usecurling.com/p/256/256?q=harry%20kane%20soccer%20england&dpr=2",
				stats: {
					"Velocidade Máxima": "31.2 km/h",
			...
			},
			{
				id: "saka",
				name: "Bukayo Saka",
				image: "https://img.usecurling.com/p/256/256?q=bukayo%20saka%20soccer%20england&dpr=2",
				stats: {
		...
		keyPlayers: [
			{
				id: "pedri",
				name: "Pedri",
				image: "https://img.usecurling.com/p/256/256?q=pedri%20soccer%20spain&dpr=2",
				stats: {
			...
			},
			{
				id: "yamal",
				name: "Lamine Yamal",
				image: "https://img.usecurling.com/p/256/256?q=lamine%20yamal%20soccer%20spain&dpr=2",
				stats: {
			...
			},
			{
				id: "rodri",
				name: "Rodri",
				image: "https://img.usecurling.com/p/256/256?q=rodri%20soccer%20spain&dpr=2",
				stats: {
		...
		keyPlayers: [
			{
				id: "musiala",
				name: "Jamal Musiala",
				image: "https://img.usecurling.com/p/256/256?q=jamal%20musiala%20soccer%20germany&dpr=2",
				stats: {
					"Velocidade Máxima": "34.2 km/h",
					"Precisão de Passe": "87%",
					Gols: 16,
			...
			},
			{
				id: "wirtz",
				name: "Florian Wirtz",
				image: "https://img.usecurling.com/p/256/256?q=florian%20wirtz%20soccer%20germany&dpr=2",
				stats: {
			...
			},
			{
				id: "kimmich",
				name: "Joshua Kimmich",
				image: "https://img.usecurling.com/p/256/256?q=joshua%20kimmich%20soccer%20germany&dpr=2",
				stats: {
		...
		keyPlayers: [
			{
				id: "leao",
				name: "Rafael Leão",
				image: "https://img.usecurling.com/p/256/256?q=rafael%20leao%20soccer%20portugal&dpr=2",
				stats: {
					"Velocidade Máxima": "36.5 km/h",
			...
			},
			{
				...
				image: "https://img.usecurling.com/p/256/256?q=bruno%20fernandes%20soccer%20portugal&dpr=2",
				stats: {
			...
			},
			{
				id: "bernardo",
				name: "Bernardo Silva",
				image: "https://img.usecurling.com/p/256/256?q=bernardo%20silva%20soccer%20portugal&dpr=2",
				stats: {
					"Velocidade Máxima": "31.5 km/h",
		...
		keyPlayers: [
			{
				id: "barella",
				name: "Nicolò Barella",
				image: "https://img.usecurling.com/p/256/256?q=nicolo%20barella%20soccer%20italy&dpr=2",
				stats: {
			...
			},
			{
				...
				image: "https://img.usecurling.com/p/256/256?q=federico%20chiesa%20soccer%20italy&dpr=2",
				stats: {
			...
			},
			{
				...
				image: "https://img.usecurling.com/p/256/256?q=alessandro%20bastoni%20soccer%20italy&dpr=2",
				stats: {
					"Velocidade Máxima": "31.8 km/h",
					"Precisão de Passe": "91%",
					Gols: 4,
									...
									children: team.keyPlayers.map((player) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Dialog, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTrigger, {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogTitle, {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												className: "p-4 rounded-xl bg-background/40 backdrop-blur-sm border border-border/20 shadow-sm",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
													className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-3 flex items-center gap-1.5",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Target, { className: "w-3.5 h-3.5" }), "Análise de Impacto"]
...
//# sourceMappingURL=CopaStatsDashboard-BPJGIlxG.js.map