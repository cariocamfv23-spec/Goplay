...
import { t as Radio } from "./radio-CxL360w4.js";
import "./wallet-4arHjo5v.js";
import { $t as TooltipProvider, Bn as Lock, Cr as createLucideIcon, Gt as Avatar, Kt as AvatarFallback, Lr as require_jsx_runtime, M as Badge, Qt as TooltipContent, Rn as MapPin, Sr as Activity, Wr as useNavigate, Xt as Button, Zt as Tooltip, br as ArrowLeft, en as TooltipTrigger, hn as User, n as AppIcon, qr as require_react, qt as AvatarImage, rr as Crown, tr as Eye, un as cn } from "./index-B1eGiQWt.js";
import { n as CardContent, t as Card } from "./card-Dk9UBOl5.js";
import "./label-Ba8Xze6-.js";
import "./input-CIe_2SDJ.js";
import "./tabs-BudGxkUn.js";
import { M as Cell, f as Bar, n as YAxis, r as XAxis } from "./generateCategoricalChart-BEhjUFHv.js";
import { t as CartesianGrid } from "./CartesianGrid-Bd8Ejp3f.js";
import { t as BarChart } from "./BarChart-tqWzGgC8.js";
import { n as ChartTooltip, r as ChartTooltipContent, t as ChartContainer } from "./chart-KsVfkJjl.js";
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						}), isUnlocked && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
							variant: "outline",
							className: "text-[9px] text-gold border-gold/30 uppercase tracking-widest bg-gold/5 shadow-[0_0_10px_hsl(var(--gold)/0.1)]",
							children: "Premium"
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
						className: "border border-border/50 bg-secondary/10 shadow-sm relative overflow-hidden",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, {
							className: cn("p-4 pt-6 transition-all duration-500", !isUnlocked && "blur-[4px] opacity-40 select-none pointer-events-none grayscale-[0.5]"),
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "w-12 h-12 bg-background rounded-full flex items-center justify-center mb-3 shadow-lg border border-border/50",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lock, { className: "w-5 h-5 text-muted-foreground" })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-sm font-bold text-foreground mb-1",
									children: "Gráfico de Engajamento"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-xs text-muted-foreground max-w-[200px] text-center mb-4",
									children: "Descubra os horários de pico e otimize sua visibilidade."
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PaymentDialog, {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
										...
										children: "Desbloquear com Premium"
									})
								})
							]
						})]
...
//# sourceMappingURL=ProfileViews-BuHjCVve.js.map