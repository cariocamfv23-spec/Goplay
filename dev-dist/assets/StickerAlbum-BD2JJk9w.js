...
import { $ as mockCurrentUser, Bn as Sparkles, Hr as createLucideIcon, Sn as cn, jn as Trophy, mi as require_react, oi as useToast, or as Info, ri as require_jsx_runtime, rr as Lock, sn as Button, ui as useNavigate, wn as X } from "./index-BOE_rkya.js";
import { t as Card } from "./card-COyyLbYf.js";
...
function StickerAlbum() {
	...
	const inviteLink = `https://goplay-app-screens-11312.goskip.app/invite/${mockCurrentUser.referralCode || "GOPLAY2024"}`;
	...
	const handleShareAction = () => {
		setTimeout(() => {
			...
			toast({
				...
				description: "Alguém se cadastrou com seu link! Você ganhou 1 pacote de figurinhas.",
				duration: 6e3
			});
		}, 4500);
	};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-[url('https://img.usecurling.com/p/1000/1000?q=soccer%20pattern&color=green')] bg-cover opacity-10 mix-blend-overlay" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "absolute top-safe pt-4 left-4 z-20",
...
//# sourceMappingURL=StickerAlbum-BD2JJk9w.js.map