import { Hr as clsx_default, di as require_react, fi as __commonJSMin, gi as __toESM, mi as __export } from "./index-B51WKH09.js";
...
var require__isKey = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var isArray$14 = require_isArray(), isSymbol$5 = require_isSymbol();
	var reIsDeepProp = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, reIsPlainProp = /^\w*$/;
	function isKey$3(value, object) {
		if (isArray$14(value)) return false;
...
var require__baseToString = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Symbol$4 = require__Symbol(), arrayMap$2 = require__arrayMap(), isArray$13 = require_isArray(), isSymbol$4 = require_isSymbol();
	...
	function baseToString$1(value) {
		...
		if (isArray$13(value)) return arrayMap$2(value, baseToString$1) + "";
...
var require__castPath = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var isArray$12 = require_isArray(), isKey$2 = require__isKey(), stringToPath = require__stringToPath(), toString$1 = require_toString();
	function castPath$2(value, object) {
		if (isArray$12(value)) return value;
...
var require_isString = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var baseGetTag$6 = require__baseGetTag(), isArray$11 = require_isArray(), isObjectLike$7 = require_isObjectLike();
	var stringTag$2 = "[object String]";
	function isString$3(value) {
		return typeof value == "string" || !isArray$11(value) && isObjectLike$7(value) && baseGetTag$6(value) == stringTag$2;
	}
...
var require__equalByTag = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Symbol$2 = require__Symbol(), Uint8Array = require__Uint8Array(), eq$1 = require_eq(), equalArrays$1 = require__equalArrays(), mapToArray = require__mapToArray(), setToArray$2 = require__setToArray();
...
var require__arrayLikeKeys = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var baseTimes = require__baseTimes(), isArguments$2 = require_isArguments(), isArray$9 = require_isArray(), isBuffer$1 = require_isBuffer(), isIndex$2 = require__isIndex(), isTypedArray$2 = require_isTypedArray();
...
var require__getTag = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	if (DataView$1 && getTag$2(new DataView$1(/* @__PURE__ */ new ArrayBuffer(1))) != dataViewTag || Map$1 && getTag$2(new Map$1()) != mapTag || Promise$1 && getTag$2(Promise$1.resolve()) != promiseTag || Set$2 && getTag$2(new Set$2()) != setTag || WeakMap$1 && getTag$2(new WeakMap$1()) != weakMapTag) getTag$2 = function(value) {
	...
	module.exports = getTag$2;
}));
var require__baseIsEqualDeep = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Stack$1 = require__Stack(), equalArrays = require__equalArrays(), equalByTag = require__equalByTag(), equalObjects = require__equalObjects(), getTag$1 = require__getTag(), isArray$8 = require_isArray(), isBuffer = require_isBuffer(), isTypedArray$1 = require_isTypedArray();
...
var require__hasPath = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var castPath = require__castPath(), isArguments$1 = require_isArguments(), isArray$7 = require_isArray(), isIndex$1 = require__isIndex(), isLength = require_isLength(), toKey$2 = require__toKey();
...
var require__baseIteratee = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var baseMatches = require__baseMatches(), baseMatchesProperty = require__baseMatchesProperty(), identity$9 = require_identity(), isArray$6 = require_isArray(), property = require_property();
	function baseIteratee$8(value) {
		if (typeof value == "function") return value;
		if (value == null) return identity$9;
		if (typeof value == "object") return isArray$6(value) ? baseMatchesProperty(value[0], value[1]) : baseMatches(value);
...
var require__isFlattenable = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var Symbol$1 = require__Symbol(), isArguments = require_isArguments(), isArray$5 = require_isArray();
...
var require__baseOrderBy = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var arrayMap$1 = require__arrayMap(), baseGet = require__baseGet(), baseIteratee$6 = require__baseIteratee(), baseMap$1 = require__baseMap(), baseSortBy = require__baseSortBy(), baseUnary = require__baseUnary(), compareMultiple = require__compareMultiple(), identity$8 = require_identity(), isArray$4 = require_isArray();
	function baseOrderBy$1(collection, iteratees, orders) {
		if (iteratees.length) iteratees = arrayMap$1(iteratees, function(iteratee) {
			if (isArray$4(iteratee)) return function(value) {
...
var require_map = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var arrayMap = require__arrayMap(), baseIteratee$5 = require__baseIteratee(), baseMap = require__baseMap(), isArray$3 = require_isArray();
	function map$2(collection, iteratee) {
		return (isArray$3(collection) ? arrayMap : baseMap)(collection, baseIteratee$5(iteratee, 3));
	}
...
var require_decimal = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(globalScope) {
		...
		P.toExponential = function(dp, rm) {
			...
			if (dp === void 0) str = toString$3(x$1, true);
			else {
				checkInt32(dp, 0, MAX_DIGITS);
				if (rm === void 0) rm = Ctor.rounding;
				else checkInt32(rm, 0, 8);
				x$1 = round(new Ctor(x$1), dp + 1, rm);
				str = toString$3(x$1, true, dp + 1);
			}
			return str;
		};
		P.toFixed = function(dp, rm) {
			var str, y$1, x$1 = this, Ctor = x$1.constructor;
			if (dp === void 0) return toString$3(x$1);
			checkInt32(dp, 0, MAX_DIGITS);
			if (rm === void 0) rm = Ctor.rounding;
			else checkInt32(rm, 0, 8);
			y$1 = round(new Ctor(x$1), dp + getBase10Exponent(x$1) + 1, rm);
			str = toString$3(y$1.abs(), false, dp + getBase10Exponent(y$1) + 1);
		...
		P.toPrecision = function(sd, rm) {
			...
			if (sd === void 0) {
				e = getBase10Exponent(x$1);
				str = toString$3(x$1, e <= Ctor.toExpNeg || e >= Ctor.toExpPos);
			} else {
				...
				e = getBase10Exponent(x$1);
				str = toString$3(x$1, sd <= e || e <= Ctor.toExpNeg, sd);
			}
			return str;
		};
		...
		P.toString = P.valueOf = P.val = P.toJSON = function() {
			...
			return toString$3(x$1, e <= Ctor.toExpNeg || e >= Ctor.toExpPos);
		};
		...
		function toString$3(x$1, isExp, sd) {
...
function getCateCoordinateOfLine(_ref5) {
	...
	if (axis.type === "category") {
		if (!axis.allowDuplicatedCategory && axis.dataKey && !(0, import_isNil$5.default)(entry[axis.dataKey])) {
	...
	var value = getValueByDataKey(entry, !(0, import_isNil$5.default)(dataKey) ? dataKey : axis.dataKey);
	return !(0, import_isNil$5.default)(value) ? axis.scale(value) : null;
}
...
function createIsCircular(areItemsEqual) {
	return function isCircular(a$1, b, state) {
		...
		var cachedA = cache.get(a$1);
		var cachedB = cache.get(b);
		if (cachedA && cachedB) return cachedA === b && cachedB === a$1;
		cache.set(a$1, b);
		cache.set(b, a$1);
		var result = areItemsEqual(a$1, b, state);
		cache.delete(a$1);
		cache.delete(b);
		return result;
	};
...
var hasOwn = Object.hasOwn || (function(object, property$2) {
	return hasOwnProperty$1.call(object, property$2);
});
...
function areObjectsEqualStrict(a$1, b, state) {
	var properties = getStrictProperties(a$1);
	var index = properties.length;
...
function createEqualityComparator(_a) {
	...
	return function comparator(a$1, b, state) {
		...
		var constructor = a$1.constructor;
		if (constructor !== b.constructor) return false;
		if (constructor === Object) return areObjectsEqual$1(a$1, b, state);
		if (isArray$2(a$1)) return areArraysEqual$1(a$1, b, state);
		if (isTypedArray != null && isTypedArray(a$1)) return areTypedArraysEqual$1(a$1, b, state);
...
export { require__baseExtremum as A, filterProps as B, getCoordinatesOfGrid as C, require__baseLt as D, require_isEqual as E, Global as F, uniqueId as G, adaptEventsOfChild as H, Legend as I, require_isFunction as J, require_isNaN as K, require__baseIteratee as L, Cell as M, ResponsiveContainer as N, require_max as O, Tooltip as P, warn as R, getCateCoordinateOfLine as S, getValueByDataKey as T, interpolateNumber as U, hasClipDot as V, isNumber as W, require_last as _, getTicks as a, getTickClassName as b, useChartWidth as c, formatAxisMap as d, Bar as f, LabelList as g, Curve as h, CartesianAxis as i, Text as j, require__baseGt as k, useOffset as l, es6_default as m, YAxis as n, useArbitraryXAxis as o, Dot as p, require_isNil as q, XAxis as r, useChartHeight as s, generateCategoricalChart as t, useYAxisWithFiniteDomainOrRandom as u, Label as v, getTicksOfAxis as w, polarToCartesian as x, formatAxisMap$1 as y, Layer as z };

//# sourceMappingURL=generateCategoricalChart-D-jErLqI.js.map