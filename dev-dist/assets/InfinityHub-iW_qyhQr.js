...
import { B as ScrollBar, En as User, R as Badge, Sn as X, Tr as CircleCheckBig, Un as Search, an as Button, bn as cn, d as Description, f as Overlay, fi as require_react, h as Title, ir as Info, l as Close, m as Root, p as Portal, ti as require_jsx_runtime, u as Content, yr as Dumbbell, z as ScrollArea, zr as Activity } from "./index-BClvu0uS.js";
					...
					children: filteredPosts.map((post) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									className: "w-full mt-auto bg-purple-600 hover:bg-purple-700 text-white rounded-xl h-11 font-semibold group-hover:shadow-md transition-shadow",
									children: "Assistir Treino"
								})
							]
						})]
					}, post.id))
					...
					children: selectedWorkout && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
										className: "bg-purple-600 text-white text-[10px] uppercase font-bold tracking-wider",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Close, {
									asChild: true,
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
										className: "w-full bg-purple-600 hover:bg-purple-700 text-white font-bold text-base h-12 rounded-xl",
										children: "Começar Treino"
									})
								})
							})
						]
...
//# sourceMappingURL=InfinityHub-iW_qyhQr.js.map