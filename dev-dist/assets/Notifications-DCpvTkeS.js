import { An as TrendingDown, Ar as Bell, Bn as ShieldCheck, Dr as Calendar, Jn as Megaphone, Kn as MessageSquare, Mn as Target, Nr as ArrowLeft, On as Trophy, V as Badge, Zr as require_jsx_runtime, an as Button, ar as Handshake, bn as cn, en as Avatar, gr as Crown, ii as useNavigate, ir as Heart, jr as Baby, kn as TrendingUp, mr as Eye, nn as AvatarImage, qn as MessageCircle, sr as GraduationCap, tn as AvatarFallback, vr as CloudLightning, xn as Zap, yr as Clock, z as useNotificationStore_default } from "./index-CDMiuv4n.js";
...
function Notifications() {
	...
	const getPriorityStyle = (priority, title = "", message = "") => {
			...
			children: hasNotifications ? Object.entries(groupedNotifications).map(([date, items]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
					...
					children: items.map((not) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: cn("p-4 rounded-xl flex gap-4 transition-all relative overflow-hidden border border-border/30 shadow-sm", not.read ? "bg-card opacity-90" : "bg-card ring-1 ring-primary/20 shadow-md", getPriorityStyle(not.priority, not.title, not.message), not.link && "cursor-pointer active:scale-[0.98]"),
						...
						children: [
							not.user ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								className: cn("mt-1 h-10 w-10 rounded-full flex items-center justify-center shrink-0 border border-border/50", not.read ? "bg-secondary/50" : "bg-secondary", isVipAlert(not.title, not.message) && "bg-gold/10 border-gold/30", not.title.toLowerCase().includes("scout") && "bg-blue-500/10 border-blue-500/30", not.title.toLowerCase().includes("sponsor") && "bg-emerald-500/10 border-emerald-500/30", not.type === "system_update" && "bg-primary/10 border-primary/30"),
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											children: not.priority === "critical" ? "Urgente" : isVipAlert(not.title, not.message) ? "VIP" : not.priority === "high" ? "Importante" : "Info"
										})]
									})
								]
							}),
...
//# sourceMappingURL=Notifications-DCpvTkeS.js.map