...
import { t as Ellipsis } from "./ellipsis-DK6-BTFd.js";
import { t as ExternalLink } from "./external-link-BN3F55SU.js";
import { t as Ghost } from "./ghost-Dis-ajBE.js";
import { n as TranslateButton, r as useLikeInteraction, t as useTranslation } from "./useTranslation-tT7bQ2Ka.js";
...
import { Bn as Medal, F as Badge, Hr as require_jsx_runtime, J as mockCurrentUser, Kr as Link, Or as createLucideIcon, Qr as require_react, Xt as AvatarFallback, Yn as Heart, Yr as useNavigate, Yt as Avatar, Zn as Hand, Zt as AvatarImage, bn as Trophy, c as NostalgiaFilter, d as DialogContent, dn as toast, en as Button, g as DialogTrigger, h as DialogTitle, hn as X, i as useAchievementStore, kn as Sparkles, l as Dialog, m as DialogHeader, mr as ChevronRight, pn as cn, r as useSoundStore_default } from "./index-DLpyukkZ.js";
import { a as CardHeader, n as CardContent, t as Card } from "./card-BkRvw9Oy.js";
import "./input-D08xNhzN.js";
...
import { t as useFeedStore } from "./useFeedStore-gMojXMqD.js";
import { t as Textarea } from "./textarea-BOvsgnZU.js";
import { t as DepthContainer } from "./DepthContainer-CIGMWUmv.js";
import "./sheet-CjlBB-sO.js";
import { a as CarouselPrevious, i as CarouselNext, n as CarouselContent, r as CarouselItem, t as Carousel } from "./carousel-CfLDl1Ss.js";
import { t as CommentsSheet } from "./CommentsSheet-DagUZdM1.js";
import "./SoundWaveVisualizer-Dfn38jcQ.js";
import { t as PostDetailDialog } from "./PostDetailDialog-iSiUhOi5.js";
import { t as FeedVideoPlayer } from "./FeedVideoPlayer-Dq054wZa.js";
...
function PostCard({ post }) {
	...
	const { language, isTranslated, isLoading, toggleTranslation, translatedTexts } = useTranslation([post.content || ""]);
	...
	const renderContent = () => {
		switch (post.type) {
			case "arena_result": return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [post.arenaResult?.banner && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trophy, { className: "w-4 h-4 text-gold" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-bold text-sm text-foreground drop-shadow-md",
								children: post.arenaResult.challengeTitle
							})]
						})
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex flex-col items-center justify-center bg-primary/10 rounded-lg p-2 min-w-[60px]",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-[10px] uppercase text-muted-foreground font-bold leading-none mb-1",
								children: "Score"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-lg font-black text-primary leading-none",
								children: post.arenaResult?.score?.toFixed(1) || "--"
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									post.arenaResult?.medal === "gold" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Medal, { className: "w-5 h-5 text-yellow-500 fill-yellow-500" }),
									post.arenaResult?.medal === "silver" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Medal, { className: "w-5 h-5 text-slate-400 fill-slate-300" }),
									post.arenaResult?.medal === "bronze" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Medal, { className: "w-5 h-5 text-orange-700 fill-orange-400" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "font-bold text-sm",
										children: [post.arenaResult?.rank, "º Lugar"]
									})
								]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						children: ["Ver Desafio ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, { className: "w-3 h-3 ml-1" })]
					})]
				})]
			});
			case "video":
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
					className: "p-4 pt-1",
					children: [
						post.content && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mb-3",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-sm leading-relaxed whitespace-pre-wrap",
								children: isTranslated ? translatedTexts[0] : post.content
							}), language !== "pt" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TranslateButton, {
								isTranslated,
								isLoading,
...
function CreatePostFab() {
	...
	const handlePost = () => {
		...
		addPost({
			...
			videoDuration: videoFile ? "0:15" : void 0
		});
...
function Feed() {
	...
	const eventPosts = posts.filter((p) => p.type === "article" || p.type === "event");
	const socialPosts = posts.filter((p) => p.type !== "article" && p.type !== "event");
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
//# sourceMappingURL=Feed-HpST_peD.js.map