...
import { B as ScrollBar, Br as Activity, Dn as User, J as mockArenaArticles, Mr as Calendar, R as Badge, Rr as ArrowLeft, Vr as createLucideIcon, Wn as Search, kn as Tv, ni as require_jsx_runtime, on as Button, pi as require_react, wr as Clock, xn as cn, z as ScrollArea } from "./index-LFXeRThl.js";
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				...
				article.broadcaster && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-3 bg-secondary/40 border border-border/50 rounded-xl p-4 text-sm font-medium text-foreground",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "p-2 bg-purple-600/10 rounded-lg",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tv, { className: "w-5 h-5 text-purple-600" })
				...
				children: filteredArticles.map((article) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							article.broadcaster && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mb-4 bg-secondary/30 rounded-lg p-2.5 flex items-center justify-between border border-border/50",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex items-center gap-2",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tv, { className: "w-4 h-4 text-purple-600" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
//# sourceMappingURL=ArenaGo-D-lZg40z.js.map