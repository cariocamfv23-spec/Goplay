import { Cr as Baby, F as Badge, Hr as require_jsx_runtime, Nn as ShieldCheck, P as useNotificationStore_default, Qn as GraduationCap, Sn as TrendingDown, Sr as Bell, Tr as ArrowLeft, Xn as Handshake, Xt as AvatarFallback, Yn as Heart, Yr as useNavigate, Yt as Avatar, Zt as AvatarImage, bn as Trophy, dr as Clock, en as Button, mn as Zap, pn as cn, ur as CloudLightning, wn as Target, xn as TrendingUp, yr as Calendar } from "./index-GT0xtY_b.js";
...
function Notifications() {
	...
	const getIcon = (type, title = "") => {
		switch (type) {
			...
			case "verification": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "h-5 w-5 text-blue-600" });
			...
			children: hasNotifications ? Object.entries(groupedNotifications).map(([date, items]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
					...
					children: items.map((not) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: cn("p-4 rounded-xl flex gap-4 transition-all relative overflow-hidden border border-border/30 shadow-sm", not.read ? "bg-card opacity-90" : "bg-card ring-1 ring-primary/20 shadow-md", getPriorityStyle(not.priority), not.link && "cursor-pointer active:scale-[0.98]"),
						...
						children: [
							not.type === "live_stream" && not.user ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								className: cn("mt-1 h-10 w-10 rounded-full flex items-center justify-center shrink-0 border border-border/50", not.read ? "bg-secondary/50" : "bg-secondary"),
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
											className: cn("font-bold text-sm leading-tight", not.read ? "text-foreground/80" : "text-foreground", not.priority === "critical" && "text-red-600 dark:text-red-400", not.type === "live_stream" && !not.link?.includes("/replay/") && "text-red-500"),
											children: not.title
										})
									}),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											...
											variant: "outline",
											className: cn("text-[10px] h-5 px-1.5 font-normal border-0", not.priority === "critical" ? "bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300" : not.priority === "high" ? "bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-300" : "bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300"),
											children: not.priority === "critical" ? "Urgente" : not.priority === "high" ? "Importante" : "Info"
										})]
									})
								]
							}),
...
//# sourceMappingURL=Notifications-CM3lE7HL.js.map