...
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-CfHbr3z3.js";
import { t as Ellipsis } from "./ellipsis-BMmVwoEl.js";
...
import { t as Send } from "./send-D6VYGx3U.js";
import { t as Share2 } from "./share-2-CO8iYm6S.js";
import { t as Trash2 } from "./trash-2-CaabTYrG.js";
import { $r as Link, Bt as DropdownMenu, C as WarningProvider, G as Popover, H as ScrollArea, Ht as DropdownMenuContent, In as Star, Jr as createContextScope, K as PopoverContent, Pr as createLucideIcon, S as Trigger, Sn as X, U as ScrollBar, Ut as DropdownMenuItem, V as Badge, Wt as DropdownMenuTrigger, Xr as useComposedRefs, Yr as require_jsx_runtime, Zr as composeEventHandlers, _ as Description, ai as require_react, an as Button, b as Root, bn as cn, en as Avatar, f as DialogHeader, g as Content, h as Close, l as DialogContent, m as DialogTrigger, nn as AvatarImage, nr as Heart, on as buttonVariants, p as DialogTitle, q as PopoverTrigger, qr as createSlottable, s as Dialog, tn as AvatarFallback, ui as __toESM, v as Overlay, vn as toast, w as createDialogScope, wn as Utensils, x as Title, y as Portal } from "./index-Ffqs5NK1.js";
import { a as CardHeader, n as CardContent, t as Card } from "./card-Dwdyf5Ps.js";
import { t as Label } from "./label-BGYksXZQ.js";
import { t as Textarea } from "./textarea-D6VrDwtf.js";
...
function FoodPostCard({ post, onDelete }) {
	const [reactions, setReactions] = (0, import_react.useState)((0, import_react.useMemo)(() => {
		const counts = {};
		if (post.likes > 0) {
			counts["🍎"] = Math.floor(post.likes * .4);
			counts["🥦"] = Math.floor(post.likes * .3);
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Popover, {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopoverTrigger, {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
												variant: "ghost",
												size: "icon",
												className: cn("h-8 w-8 rounded-full transition-all duration-300", userReaction ? "bg-orange-500/15 hover:bg-orange-500/25 scale-105 shadow-sm ring-1 ring-orange-500/30" : "text-muted-foreground hover:text-orange-500 hover:bg-orange-500/10 hover:scale-105"),
												children: userReaction ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: "text-[18px] leading-none transform -translate-y-[1px]",
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												...
												children: FOOD_EMOJIS.map((emoji) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
													className: cn("h-9 w-9 text-xl flex items-center justify-center rounded-full hover:bg-secondary/80 transition-all hover:scale-125 focus:outline-none", userReaction === emoji && "bg-secondary scale-110 shadow-inner ring-1 ring-border"),
...
//# sourceMappingURL=FoodSport-DKOiO57E.js.map