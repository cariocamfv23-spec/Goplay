import "./circle-alert-BVrAMDGG.js";
import "./circle-check-BOZMoG1N.js";
import { t as PaymentDialog } from "./PaymentDialog-DsSWfwFE.js";
import { t as Radio } from "./radio-TGEPoqpM.js";
import "./wallet-Lz0IttT4.js";
import { Gt as Avatar, Ir as require_jsx_runtime, Kr as require_react, Kt as AvatarFallback, Ln as MapPin, M as Badge, Ur as useNavigate, Xt as Button, er as Eye, ln as cn, mn as User, n as AppIcon, nr as Crown, qt as AvatarImage, xr as Activity, yr as ArrowLeft } from "./index-B4C18nT5.js";
import { n as CardContent, t as Card } from "./card-7f2rIYUy.js";
import "./label-BP5ZoQNO.js";
import "./input-DvXz7g1S.js";
import "./tabs-A0scp8MI.js";
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Avatar, {
											className: cn("w-10 h-10 border-2 border-primary shadow-[0_0_15px_hsl(var(--primary)/0.4)] transition-all duration-300", isBlurredRadar && "blur-[3px] grayscale opacity-70"),
										...
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -bottom-1 -right-1 w-3.5 h-3.5 bg-gold border-2 border-background rounded-full animate-pulse shadow-[0_0_8px_hsl(var(--gold))]" })]
									})
								}, v.id);
							})
						]
						...
						children: allViewers.map((viewer, index) => {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
										className: cn("border-none shadow-sm transition-all relative overflow-hidden", isBlurred && "blur-sm opacity-60 select-none pointer-events-none", viewer.isLive && !isBlurred && "ring-1 ring-gold/30 bg-gradient-to-r from-primary/5 to-transparent shadow-[0_0_15px_hsl(var(--primary)/0.05)]"),
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
											className: "p-4 flex items-center gap-4 relative z-10",
											children: [
												viewer.isLive && !isBlurred && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute top-0 right-0 w-24 h-24 bg-primary/10 rounded-full blur-2xl -mr-10 -mt-10 pointer-events-none" }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													className: "relative z-10",
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Avatar, {
														className: cn("h-12 w-12 border-2", viewer.isLive && !isBlurred ? "border-primary shadow-[0_0_10px_hsl(var(--primary)/0.3)]" : "border-border"),
													...
													}), viewer.isLive && !isBlurred && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -bottom-0.5 -right-0.5 w-3.5 h-3.5 bg-gold border-2 border-background rounded-full animate-pulse shadow-[0_0_8px_hsl(var(--gold))]" })]
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														...
														children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
															...
															className: cn("whitespace-nowrap", viewer.isLive ? "text-[10px] font-black tracking-widest uppercase rounded-full px-2 py-0.5 bg-gold/10 text-gold border border-gold/20 shadow-sm" : "text-xs font-bold text-muted-foreground"),
...
//# sourceMappingURL=ProfileViews-D8tCMEPU.js.map