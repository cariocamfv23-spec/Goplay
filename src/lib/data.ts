...
export const mockPosts = [
  ...
  },
  {
    ...
    user: {
      ...
      name: 'NBA Brasil',
      type: 'Liga',
      avatar: 'https://img.usecurling.com/i?q=nba%20logo&color=blue',
    },
    time: '5h',
    title: 'Curry on fire! 🔥',
    content:
      'Mais uma performance histórica de Stephen Curry com 10 bolas de 3 pontos.',
    media: [
      'https://img.usecurling.com/p/600/400?q=basketball%20game%20action&color=blue',
    ],
    videoDuration: '0:58',
    hashtags: ['#nba', '#basketball', '#curry'],
    likes: 12500,
    comments: 840,
    shares: 3200,
    applauds: 1500,
    ...
    socialContext: {
      type: 'comment',
      user: { id: 'u4', name: 'Carlos Eduardo' },
    },
  },
  {
    id: 102,
    ...
    user: {
      ...
      type: 'Liga',
      avatar: 'https://img.usecurling.com/i?q=surf%20logo&color=cyan',
    },
    time: '8h',
    title: 'Nazaré Gigante',
    content: 'As ondas gigantes de Nazaré nunca decepcionam. Coragem pura!',
    media: [
      'https://img.usecurling.com/p/600/600?q=big%20wave%20surfing&color=cyan',
    ],
    hashtags: ['#wsl', '#surf', '#bigwaves'],
    likes: 8900,
    comments: 420,
    shares: 1100,
    applauds: 2000,
    ...
    socialContext: {
      type: 'comment',
      user: { id: 'u7', name: 'Fernanda Oliveira' },
    },
  },
  {
    id: 2,
