export const SportsPatternPaths = () => (
  // High-Fidelity WhatsApp-style Sports Doodles
  // Staggered grid layout for seamless tiling and premium aesthetic
  <g
    fill="none"
    stroke="currentColor"
    strokeWidth="1.5"
  ...
  >
    ...
    {/* Swimming */}
    <g transform="translate(140, 105) scale(1.2)">
    ...
    {/* Heart Rate */}
    <g transform="translate(300, 265) scale(1.1)">
